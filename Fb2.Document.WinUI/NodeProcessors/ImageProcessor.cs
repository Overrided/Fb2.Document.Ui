...
namespace Fb2.Document.WinUI.NodeProcessors
{
    ...
    {
        public const string NotInlineImageTag = "NotInlineFb2Image";
        ...
        public override List<TextElement> Process(IRenderingContext context)
        {
            ...
            if (!isInlineImage)
                TagElement(image, NotInlineImageTag);
        ...
        private static Border GetCenteringBorder(double viewPortWidth) =>
            new Border
            {
